...
@section('title')
                        ...
                        <div class="col-xxl-3 col-xl-3 col-sm-6 col-md-3 widget">
                            <a href="{{route('total_order')}}" class="mb-xl-8 text-decoration-none">
                                <div
                                    ...
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">{{ count($order) }}
                                        </h2>
                        ...
                        <div class="card-body pt-7">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6" style="text-align: end;">
                                    <h4>Create Order </h4>
                                    <a href="" onclick="createOrder(event)" id="gos_bg_color" style="width: 9.563rem !important" class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0 px-5"
    ...
    event.preventDefault(); // Prevent default anchor behavior
    window.location.href = "{{ route('forms.order.form.create') }}";
