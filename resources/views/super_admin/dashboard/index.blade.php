                           ...
                           class="mb-xl-8 text-decoration-none">
                            ...
                            <div
                                ...
                                <div class="text-end text-white">
                                    ...
                                    <h3 class="mb-0 fs-4 fw-light">{{ __('Total Forms') }}</h3>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href=""
                           class="mb-xl-8 text-decoration-none">
                            ...
                            <div
                                ...
                                <div class="text-end text-white">
                                    <h2 class="fs-1-xxl fw-bolder text-white">{{count($submited)}}</h2>
                                    <h3 class="mb-0 fs-4 fw-light">{{ __('Total Submited Form') }}</h3>
                                </div>
                            </div>
                        </a>
                    </div>
