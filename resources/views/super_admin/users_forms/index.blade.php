    ...
    <h6 class="alert alert-danger">
        {{ session('error') }}
            ...
            <div class="row">
                <div class="col-md-6">
                <!--    <h4>Letter Form</h4>-->
                <!--   <a href="{{route('forms.letter.form.create')}}" class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0"-->
                ...
                <!--    <h4>Order Form</h4>-->
                <!--    <a href="" class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0"-->
                ...
                <!--    </span>-->
                <!--</a>-->
                <h4 style="text-align: center">All Users Form Data</h4>
                </div>
            </div>
