...
<body>
    ...
    <div class="preview-main client-preview istanbul-template">
        <div class="d" id="boxes">
            <div class="d-inner">
                <div class="w-100">
                    <div class="top-line w-100" style="background-color: {{ $quote_template_color }};">
                    </div>
                    <div class="invoice-header">
                        <table class="overflow-hidden w-100 mb-0">
                            <tr>
                                <td class="">
                                    <div class="p-3 ms-5">
                                        <img height="60px" src="{{ getLogoUrl($quote->tenant_id) }}" alt="">
                                    </div>
                                </td>
                                <td class="heading-text">
                                    ...
                                    <div class="text-before"
                                        {{ $styleCss }}="background-color: {{ $quote_template_color }};"></div>
                ...
                <div class="address px-3">
                    <div class="address-after" {{ $styleCss }}="background-color: {{ $quote_template_color }};">
                    </div>
                ...
                <div class="bottom-line" {{ $styleCss }}="background-color: {{ $quote_template_color }};">
                </div>
            </div>
        </div>
    </div>
